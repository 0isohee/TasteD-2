  ...
  <div>
    <div>
      <div class="titleContainer">
        <h3 class="text-h4 font-weight-bold pb-4">후기 게시글 등록</h3>
      </div>
      <!-- <v-divider></v-divider> -->
    </div>
                ...
                <v-card-text>
                  ...
                  <form>
                    ...
                    <div class="btnContainer">
                      <v-btn color="hover" @click.prevent="confirmInsert">글 등록</v-btn>
                      <v-btn color="white" @click.prevent="goToReviewList">목록 이동</v-btn>
                    </div>
                  </form>
                </v-card-text>
              </v-card>
